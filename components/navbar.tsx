            ...
            {links.map((link, index) => (
              <motion.div key={link.title} variants={itemVariants} custom={index}>
                <DropdownMenuItem className="p-0 focus:bg-transparent">
                  <Link href={link.href} className={`block w-full py-2 px-3 text-gray-700 rounded-md transition-colors ${link.showAll ? "font-bold text-[#0a72bd] mt-2 border-t pt-3" : "hover:bg-gray-100"}`}>
                    {link.title}
                  </Link>
                </DropdownMenuItem>
              </motion.div>
...
export default function Navbar() {
  ...
  const navDropdowns = [
    { title: "People", links: [{ title: "Corporate", href: "/people/one" }, { title: "Disputes", href: "/people/two" }, { title: "Finance", href: "/people/three" }, { title: "M&A", href: "/people/one" }, { title: "Notarial Service", href: "/people/two" }, { title: "Private Equity", href: "/people/three" }, { title: "Real Estate", href: "/people/one" }, { title: "Tax", href: "/people/two" }, { title: "Tech & Data", href: "/people/three" }, { title: "Venture Capital", href: "/people/one" }, { title: "People & Culture", href: "/people/two" }, { title: "Operations", href: "/people/three" }, { title: "Marketing", href: "/people/one" }, { title: "Show All", href: "/people/two", showAll: true }] },
    { title: "Expertise", links: [{ title: "Corporate", href: "/people/one" }, { title: "Disputes", href: "/people/two" }, { title: "Finance", href: "/people/three" }, { title: "M&A", href: "/people/one" }, { title: "Notarial Service", href: "/people/two" }, { title: "Private Equity", href: "/people/three" }, { title: "Real Estate", href: "/people/one" }, { title: "Tax", href: "/people/two" }, { title: "Tech & Data", href: "/people/three" }, { title: "Venture Capital", href: "/people/one" }, { title: "Show All", href: "/people/two", showAll: true }] },
