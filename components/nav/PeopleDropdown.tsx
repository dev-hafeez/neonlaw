...
import type { PeopleMenuData } from "@/lib/adapters/peopleMenu";
                              ...
                              <div className="w-full h-10 px-3 flex items-center justify-between">
                                ...
                                <Link
                                  ...
                                  className={`truncate text-sm hover:text-black ${
                                    selected ? "text-blue-400 font-semibold" : "text-gray-900"
                                  }`}
                                >
                                  {c.name}
                                </Link>
                                ...
                                <button
                                  ...
                                  className={`ml-2 p-1 rounded-md transition-colors ${
                                    selected ? "text-blue-600" : "text--400 group-hover:text-blue-600"
                                  }`}
                                  onClick={(e) => {
                                    e.preventDefault();
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-1.5 p-3">
                          {activeCat.people.map((p) => (
                            <Link
                              ...
                              className="text-[13px] text-gray-800 hover:text-blue-600 truncate"
                              onClick={() => onOpenChange(false)}
                            >
                              {p.title}
                            </Link>
