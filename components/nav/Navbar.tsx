    ...
    <nav className="fixed top-0 left-0 right-0 z-50">
      ...
      <div className="hidden lg:flex px-4 py-3 justify-between items-center mt-4">
        ...
        <Link href="/Career?category=Jobs"
          className={`bg-[#0a72bd] flex flex-col items-center justify-center text-white rounded-xl w-[140px] px-4 py-2 shadow-md border border-gray-200 hover:scale-105 transition-transform h-14 hover:bg-[#084a7a] ${showApplyNowOnly ? 'opacity-100' : 'opacity-70'}`}
